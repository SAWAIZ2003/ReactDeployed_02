...
class MyTranscriptionPipeline {
    static task = 'automatic-speech-recognition';  // Task type for ASR
    static model = 'openai/whisper-tiny.en';  // Model path (ensure it's correct and accessible)
...
class GenerationTracker {
    ...
    sendFinalResult() {
        self.postMessage({ type: 'INFERENCE_DONE' });
    }
