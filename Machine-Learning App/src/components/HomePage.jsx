...
export default function HomePage(props) {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen pb-20">
      {/* Main content */}
      <main className="flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20">
        ...
        <p className="text-base">
          Or{' '}
          <label className="cursor-pointer text-blue-500 hover:text-blue-600 duration-200">
            Upload{' '}
            <input
              onChange={(e) => {
